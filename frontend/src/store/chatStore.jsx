...
// ── State shape ──────────────────────────────────────────────────────────────
/** @typedef {{ id: string, messages: Message[], loading: boolean }} Session */
/** @typedef {{ role: 'user'|'assistant', content: string, created_at?: string }} Message */
...
const initialState = {
  ...
  loading: false,
  /** streaming: false | 'streaming' | 'done' */
  streamState: false,
  /** User-selected mode: true = streaming SSE, false = blocking */
  streamingEnabled: true,
  /** Agent info from /api/v1/info */
  agentInfo: null,
...
/** Convenience: returns the active session object or null */
